 ...
 * @time:2018/8/28
 */
public class PushSwipeRefreshLayout extends ViewGroup implements NestedScrollingParent,
    ...
    public PushSwipeRefreshLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
...
*/
    ...
    /**
     * Classes that wish to override {@link PushSwipeRefreshLayout#canChildScrollUp()} method
     * behavior should implement this interface.
     */
    public interface OnChildScrollUpCallback {
        /**
         * Callback that will be called when {@link PushSwipeRefreshLayout#canChildScrollUp()} method
         ...
         */
        boolean canChildScrollUp(@NonNull PushSwipeRefreshLayout parent, @Nullable View child);

        /**
         * Callback that will be called when {@link PushSwipeRefreshLayout#canChildScrollDown()} method
         * is called to allow the implementer to override its behavior.
         *
         * @param parent SwipeRefreshLayout that this callback is overriding.
         * @param child  The child view of SwipeRefreshLayout.
         ...
         */
        boolean canChildScrollDown(@NonNull PushSwipeRefreshLayout parent, @Nullable View child);
    }
